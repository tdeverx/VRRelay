...
case "$(uname -m)" in
  x86_64)
    ARCHIVE='ffmpeg-n7.1.5-1-g7d0e842004-linux64-gpl-7.1.tar.xz'
    ;;
  aarch64 | arm64)
    ARCHIVE='ffmpeg-n7.1.5-1-g7d0e842004-linuxarm64-gpl-7.1.tar.xz'
    ;;
  *)
...
URL="https://github.com/BtbN/FFmpeg-Builds/releases/download/autobuild-2026-06-30-13-34/$ARCHIVE"
...
[[ "$VERSION_OUTPUT" == *'ffmpeg version n7.1.5-1-g7d0e842004'* ]]
