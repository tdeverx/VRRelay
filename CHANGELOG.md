...
- Re-pinned bundled Linux and Windows FFmpeg to BtbN's retained July 2026 month-end build so clean
  CI, container, and native-package builds no longer depend on an expired daily release.
