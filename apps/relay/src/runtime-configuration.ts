...
export function publicRuntimeConfiguration(
  ...
  return {
    configuration: {
      ...
      liveMaxChannelsTotal: config.liveMaxChannelsTotal,
      liveMaxChannelsPerOwner: config.liveMaxChannelsPerOwner,
      liveNormalizerMaxConcurrent: config.liveNormalizerMaxConcurrent,
      liveNormalizerMaxPerOwner: config.liveNormalizerMaxPerOwner,
