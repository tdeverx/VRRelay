...
Notable runtime and source dependencies include Node.js, FFmpeg, MediaMTX, WinSW, SvelteKit, Svelte, Fastify, Zod, shadcn-svelte/Bits UI primitives, SQLite, PostgreSQL clients, Valkey/Redis clients, and cloud object-storage SDKs. Their own copyright notices and license terms continue to apply.
